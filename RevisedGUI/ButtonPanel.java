...
public class ButtonPanel extends javax.swing.JPanel implements ActionListener {
	...
	*/
	...
	private void initGUI() {
		try {
			...
			this.setSize(350, 150);
			{
				...
				openingButtonPanel.setBackground(new java.awt.Color(0,128,192));
				{
			...
			}
			{
				...
				rollButtonPanel.setBackground(new java.awt.Color(0,128,192));
				{
			...
			}
			{
				...
				tradeButtonPanel.setBackground(new java.awt.Color(0,128,192));
				{
					jLabel1 = new JLabel();
			...
			}
			{
				...
				buildButtonPanel.setBackground(new java.awt.Color(0,128,192));
				{
					jLabel2 = new JLabel();
	...
	public void actionPerformed(ActionEvent evt) {
		...
		{
			System.out.println("Opening's next button was pressed!");
			CardLayout layout = (CardLayout)this.getLayout();
			layout.show(this, "ROLL");
		}
		if(evt.getSource() == roll_next)
		{
			System.out.println("Roll's next button was pressed!");
			CardLayout layout = (CardLayout)this.getLayout();
			layout.show(this, "TRADE");
		}
		if(evt.getSource() == trade_next)
		{
			System.out.println("Trade's next button was pressed!");
			CardLayout layout = (CardLayout)this.getLayout();
			layout.show(this, "BUILD");
		}
		if(evt.getSource() == build_next)
		{
			System.out.println("Build's next button was pressed!");
			CardLayout layout = (CardLayout)this.getLayout();
			layout.show(this, "ROLL");
		}
	}
