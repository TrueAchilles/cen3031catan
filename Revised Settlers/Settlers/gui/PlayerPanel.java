	...
	*/
	...
	public void addPlayer(String name) {
		...
		if(player1.isVisible() == false)
		{
			...
			System.out.println(player1.getHeight() + ", " + player1.getWidth());
		...
		else if(player2.isVisible() == false)
		{
			...
			System.out.println(player2.getHeight() + ", " + player2.getWidth());
		...
		else if(player3.isVisible() == false)
		{
			...
			System.out.println(player3.getHeight() + ", " + player3.getWidth());
		...
		else
		{
			...
			System.out.println(player4.getHeight() + ", " + player4.getWidth());
