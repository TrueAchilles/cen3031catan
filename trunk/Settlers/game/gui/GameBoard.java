...
class GameBoard extends JPanel implements MouseListener, MouseMotionListener, SettlersConstants{
	...
	/*
	  *Repaints the screen when necessary
	  *@param g The graphics object for painting to the screen
	  */
	...
	/*
	  *Redraws the entire screen starting with the hexagons and then moving on to the existing roads and settlements
	  *@param g the Graphics object that allows us to paint all of the objects on the board
	  */
    ...
    /*
	  *Initializes the gameboard panel by first getting the width and height of the screen and then creating and initializing the board.&
	  *It finishes by calling the repaint() method to paint the board to the screen
	  *@param _tiles not used
	  */
	...
	/*
	  *on a mouse click this method  throws a SettlementEvent to build a settlement or a road and repaints the board with the updated road or settlement
	  *@param x not used
	  *@param y not used
	  */
	...
	/*
	  *Geometrically calculates the location of the mouse pointer and determines whether there can be a settlement or road built at that location
	...
	/*
	  *Hides or displays the box for the dice
	  *@param value whether the dice box is to be displayed or not
	  */
